...
def test_mesh_material_loading():
    ...
    nptest.assert_allclose(
        mesh1_material.getBaseColorFactor().flatten(), [0.7, 0.7, 0.7, 1], atol=0.01
    )
    ...
    nptest.assert_allclose(
        mesh3_material.getBaseColorFactor().flatten(), [0.05, 0.8, 0.05, 1], atol=0.01
    )
    ...
    nptest.assert_allclose(
        mesh3_material.getEmissiveFactor().flatten(), [0.1, 0.1, 0.5, 1], atol=0.01
    )
