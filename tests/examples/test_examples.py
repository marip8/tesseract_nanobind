...
def test_geometry_showcase_example():
    tesseract.examples.geometry_showcase_example()
...
def test_raster_example():
    tesseract.examples.raster_example()


@pytest.mark.planning
def test_online_planning_example():
    tesseract.examples.online_planning_example()


@pytest.mark.planning
def test_online_planning_sqp_example():
    tesseract.examples.online_planning_sqp_example()


@pytest.mark.planning
def test_freespace_hybrid_example():
    tesseract.examples.freespace_hybrid_example()


@pytest.mark.planning
def test_chain_example():
    tesseract.examples.chain_example()
...
def test_lowlevel_collision_example():
    tesseract.examples.tesseract_collision_c_api_example()


@pytest.mark.lowlevel
@pytest.mark.basic
def test_lowlevel_kinematics_example():
    tesseract.examples.tesseract_kinematics_c_api_example()


@pytest.mark.lowlevel
@pytest.mark.basic
def test_lowlevel_scene_graph_example():
    tesseract.examples.scene_graph_c_api_example()


@pytest.mark.lowlevel
@pytest.mark.planning
def test_lowlevel_freespace_ompl_example():
    tesseract.examples.freespace_ompl_c_api_example()


@pytest.mark.lowlevel
@pytest.mark.planning
def test_lowlevel_basic_cartesian_example():
    tesseract.examples.basic_cartesian_c_api_example()


@pytest.mark.lowlevel
@pytest.mark.planning
def test_lowlevel_glass_upright_example():
    tesseract.examples.glass_upright_c_api_example()


@pytest.mark.lowlevel
@pytest.mark.planning
def test_lowlevel_puzzle_piece_example():
    tesseract.examples.puzzle_piece_c_api_example()


@pytest.mark.lowlevel
@pytest.mark.planning
def test_lowlevel_pick_and_place_example():
    tesseract.examples.pick_and_place_c_api_example()


@pytest.mark.lowlevel
@pytest.mark.planning
def test_lowlevel_car_seat_example():
    tesseract.examples.car_seat_c_api_example()


@pytest.mark.lowlevel
@pytest.mark.planning
def test_lowlevel_puzzle_piece_auxillary_axes_example():
    tesseract.examples.puzzle_piece_auxillary_axes_c_api_example()


@pytest.mark.lowlevel
@pytest.mark.planning
def test_lowlevel_pythonic_example():
    tesseract.examples.pythonic_c_api_example()


@pytest.mark.lowlevel
@pytest.mark.planning
def test_lowlevel_planning_composer_example():
    tesseract.examples.tesseract_planning_composer_c_api_example()


@pytest.mark.lowlevel
@pytest.mark.planning
def test_lowlevel_planning_lowlevel_example():
    tesseract.examples.tesseract_planning_lowlevel_c_api_example()


@pytest.mark.lowlevel
@pytest.mark.planning
def test_lowlevel_trajopt_ifopt_example():
    tesseract.examples.tesseract_planning_lowlevel_trajopt_ifopt_example()
