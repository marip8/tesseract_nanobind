...
class DescartesSolverProfileD(tesseract.command_language._tesseract_command_language.Profile):
    def getKey(self) -> int: ...
...
def cast_DescartesSolverProfileD(profile: DescartesLadderGraphSolverProfileD) -> tesseract.command_language._tesseract_command_language.Profile:
    """
    Cast DescartesLadderGraphSolverProfileD to Profile for use with ProfileDictionary
    """

class DescartesMoveProfileD(tesseract.command_language._tesseract_command_language.Profile):
    def getKey(self) -> int: ...
...
class DescartesDefaultMoveProfileD(DescartesMoveProfileD):
    ...
    @property
    def vertex_collision_check_config(self) -> tesseract.collision._tesseract_collision.CollisionCheckConfig: ...

    @vertex_collision_check_config.setter
    def vertex_collision_check_config(self, arg: tesseract.collision._tesseract_collision.CollisionCheckConfig, /) -> None: ...
    ...
    @property
    def edge_collision_check_config(self) -> tesseract.collision._tesseract_collision.CollisionCheckConfig: ...

    @edge_collision_check_config.setter
    def edge_collision_check_config(self, arg: tesseract.collision._tesseract_collision.CollisionCheckConfig, /) -> None: ...
...
def cast_DescartesMoveProfileD(profile: DescartesDefaultMoveProfileD) -> tesseract.command_language._tesseract_command_language.Profile:
    """
    Cast DescartesDefaultMoveProfileD to Profile for use with ProfileDictionary
    """

def cast_DescartesPlanProfileD(profile: DescartesDefaultMoveProfileD) -> tesseract.command_language._tesseract_command_language.Profile:
