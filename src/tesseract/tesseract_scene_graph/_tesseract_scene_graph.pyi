...
import tesseract.tesseract_geometry._tesseract_geometry
...
class JointLimits:
    ...
    @overload
    def __init__(self, lower: float, upper: float, effort: float, velocity: float, acceleration: float, jerk: float) -> None: ...
...
class JointSafety:
    ...
    @overload
    def __init__(self, soft_upper_limit: float, soft_lower_limit: float, k_position: float, k_velocity: float) -> None: ...
...
class Joint:
    ...
    @axis.setter
    def axis(self, arg: Annotated[NDArray[numpy.float64], dict(shape=(3), order='C')], /) -> None: ...
    ...
    def parent_to_joint_origin_transform(self, arg: "Eigen::Transform<double, 3, 1, 0>", /) -> None: ...
...
class Material:
    ...
    @color.setter
    def color(self, arg: Annotated[NDArray[numpy.float64], dict(shape=(4), order='C')], /) -> None: ...
...
class Visual:
    ...
    @property
    def geometry(self) -> tesseract.tesseract_geometry._tesseract_geometry.Geometry: ...

    @geometry.setter
    def geometry(self, arg: tesseract.tesseract_geometry._tesseract_geometry.Geometry, /) -> None: ...
