...
class TrajOptIfoptMoveProfile(tesseract.command_language._tesseract_command_language.Profile):
    def getKey(self) -> int: ...

TrajOptIfoptPlanProfile: TypeAlias = TrajOptIfoptMoveProfile

class TrajOptIfoptCompositeProfile(tesseract.command_language._tesseract_command_language.Profile):
    def getKey(self) -> int: ...

class TrajOptIfoptSolverProfile(tesseract.command_language._tesseract_command_language.Profile):
    def getKey(self) -> int: ...
...
def ProfileDictionary_addTrajOptIfoptMoveProfile(dict: tesseract.command_language._tesseract_command_language.ProfileDictionary, ns: str, profile_name: str, profile: TrajOptIfoptMoveProfile) -> None:
    """Add TrajOptIfopt move profile to ProfileDictionary"""

def ProfileDictionary_addTrajOptIfoptPlanProfile(dict: tesseract.command_language._tesseract_command_language.ProfileDictionary, ns: str, profile_name: str, profile: TrajOptIfoptMoveProfile) -> None:
    """Add TrajOptIfopt plan profile to ProfileDictionary (legacy alias)"""

def ProfileDictionary_addTrajOptIfoptCompositeProfile(dict: tesseract.command_language._tesseract_command_language.ProfileDictionary, ns: str, profile_name: str, profile: TrajOptIfoptCompositeProfile) -> None:
    """Add TrajOptIfopt composite profile to ProfileDictionary"""

def ProfileDictionary_addTrajOptIfoptSolverProfile(dict: tesseract.command_language._tesseract_command_language.ProfileDictionary, ns: str, profile_name: str, profile: TrajOptIfoptSolverProfile) -> None:
