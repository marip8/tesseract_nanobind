...
from tesseract import ensure_configured

ensure_configured()

# Import dependencies first to register their types for cross-module access
import tesseract.tesseract_common  # noqa: E402, F401 - needed for CollisionMarginData, ACM
import tesseract.tesseract_kinematics  # noqa: E402, F401 - needed for getKinematicGroup
import tesseract.tesseract_scene_graph  # noqa: E402, F401
import tesseract.tesseract_srdf  # noqa: E402, F401 - needed for getKinematicsInformation
from tesseract.tesseract_environment._tesseract_environment import *  # noqa: E402

# Re-export AnyPoly_wrap_EnvironmentConst from tesseract_task_composer for convenience
try:
    from tesseract.tesseract_task_composer import AnyPoly_wrap_EnvironmentConst
except ImportError:
