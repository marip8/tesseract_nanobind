...
import tesseract.collision._tesseract_collision
...
class OMPLMoveProfile(tesseract.command_language._tesseract_command_language.Profile):
    def getKey(self) -> int: ...
...
class OMPLRealVectorMoveProfile(OMPLMoveProfile):
    ...
    @property
    def contact_manager_config(self) -> tesseract.collision._tesseract_collision.ContactManagerConfig:
        """The contact manager configuration (collision margins)"""

    @contact_manager_config.setter
    def contact_manager_config(self, arg: tesseract.collision._tesseract_collision.ContactManagerConfig, /) -> None: ...

    @property
    def collision_check_config(self) -> tesseract.collision._tesseract_collision.CollisionCheckConfig:
        """The collision check configuration"""

    @collision_check_config.setter
    def collision_check_config(self, arg: tesseract.collision._tesseract_collision.CollisionCheckConfig, /) -> None: ...

OMPLRealVectorPlanProfile: TypeAlias = OMPLRealVectorMoveProfile

def OMPLMoveProfile_as_ProfileConstPtr(profile: OMPLMoveProfile) -> tesseract.command_language._tesseract_command_language.Profile:
    """
    Convert OMPLMoveProfile to Profile::ConstPtr for use with ProfileDictionary.addProfile
    """

def OMPLPlanProfile_as_ProfileConstPtr(profile: OMPLMoveProfile) -> tesseract.command_language._tesseract_command_language.Profile:
    """Convert OMPLPlanProfile to Profile::ConstPtr (legacy alias)"""

def ProfileDictionary_addOMPLMoveProfile(dict: tesseract.command_language._tesseract_command_language.ProfileDictionary, ns: str, profile_name: str, profile: OMPLMoveProfile) -> None:
    """Add OMPL move profile to ProfileDictionary"""

def ProfileDictionary_addOMPLProfile(dict: tesseract.command_language._tesseract_command_language.ProfileDictionary, ns: str, profile_name: str, profile: OMPLMoveProfile) -> None:
