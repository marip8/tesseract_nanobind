...
import tesseract.command_language._tesseract_command_language
...
class TrajOptMoveProfile(tesseract.command_language._tesseract_command_language.Profile):
    def getKey(self) -> int: ...

TrajOptPlanProfile: TypeAlias = TrajOptMoveProfile

class TrajOptCompositeProfile(tesseract.command_language._tesseract_command_language.Profile):
    def getKey(self) -> int: ...
...
class TrajOptSolverProfile(tesseract.command_language._tesseract_command_language.Profile):
    @property
...
def ProfileDictionary_addTrajOptMoveProfile(dict: tesseract.command_language._tesseract_command_language.ProfileDictionary, ns: str, profile_name: str, profile: TrajOptMoveProfile) -> None:
    """Add TrajOpt move profile to ProfileDictionary"""

def ProfileDictionary_addTrajOptPlanProfile(dict: tesseract.command_language._tesseract_command_language.ProfileDictionary, ns: str, profile_name: str, profile: TrajOptMoveProfile) -> None:
    """Add TrajOpt plan profile to ProfileDictionary (legacy alias)"""

def ProfileDictionary_addTrajOptCompositeProfile(dict: tesseract.command_language._tesseract_command_language.ProfileDictionary, ns: str, profile_name: str, profile: TrajOptCompositeProfile) -> None:
    """Add TrajOpt composite profile to ProfileDictionary"""

def ProfileDictionary_addTrajOptSolverProfile(dict: tesseract.command_language._tesseract_command_language.ProfileDictionary, ns: str, profile_name: str, profile: TrajOptSolverProfile) -> None:
