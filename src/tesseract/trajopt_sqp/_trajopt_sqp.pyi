...
class QPProblem:
    ...
    def addConstraintSet(self, constraint_set: tesseract.trajopt_ifopt._trajopt_ifopt.ConstraintSet) -> None:
        """Add a set of constraints"""

    def addCostSet(self, constraint_set: tesseract.trajopt_ifopt._trajopt_ifopt.ConstraintSet, penalty_type: CostPenaltyType) -> None:
...
class IfoptProblem:
    ...
    def __init__(self, variables: tesseract.trajopt_ifopt._trajopt_ifopt.Variables) -> None: ...

    def addConstraintSet(self, constraint_set: tesseract.trajopt_ifopt._trajopt_ifopt.ConstraintSet) -> None: ...

    def addCostSet(self, cost_set: tesseract.trajopt_ifopt._trajopt_ifopt.ConstraintSet) -> None: ...
