...
import tesseract.tesseract_command_language._tesseract_command_language
import tesseract.tesseract_motion_planners._tesseract_motion_planners
import tesseract.trajopt_ifopt._trajopt_ifopt
...
class TrajOptMoveProfile(tesseract.tesseract_command_language._tesseract_command_language.Profile):
    def getKey(self) -> int: ...

TrajOptPlanProfile: TypeAlias = TrajOptMoveProfile

class TrajOptCompositeProfile(tesseract.tesseract_command_language._tesseract_command_language.Profile):
    def getKey(self) -> int: ...
...
class TrajOptDefaultCompositeProfile(TrajOptCompositeProfile):
    ...
    @property
    def collision_cost_config(self) -> tesseract.trajopt_ifopt._trajopt_ifopt.TrajOptCollisionConfig: ...

    @collision_cost_config.setter
    def collision_cost_config(self, arg: tesseract.trajopt_ifopt._trajopt_ifopt.TrajOptCollisionConfig, /) -> None: ...

    @property
    def collision_constraint_config(self) -> tesseract.trajopt_ifopt._trajopt_ifopt.TrajOptCollisionConfig: ...

    @collision_constraint_config.setter
    def collision_constraint_config(self, arg: tesseract.trajopt_ifopt._trajopt_ifopt.TrajOptCollisionConfig, /) -> None: ...
...
class TrajOptSolverProfile(tesseract.tesseract_command_language._tesseract_command_language.Profile):
    @property
...
def ProfileDictionary_addTrajOptMoveProfile(dict: tesseract.tesseract_command_language._tesseract_command_language.ProfileDictionary, ns: str, profile_name: str, profile: TrajOptMoveProfile) -> None:
    """Add TrajOpt move profile to ProfileDictionary"""

def ProfileDictionary_addTrajOptPlanProfile(dict: tesseract.tesseract_command_language._tesseract_command_language.ProfileDictionary, ns: str, profile_name: str, profile: TrajOptMoveProfile) -> None:
    """Add TrajOpt plan profile to ProfileDictionary (legacy alias)"""

def ProfileDictionary_addTrajOptCompositeProfile(dict: tesseract.tesseract_command_language._tesseract_command_language.ProfileDictionary, ns: str, profile_name: str, profile: TrajOptCompositeProfile) -> None:
    """Add TrajOpt composite profile to ProfileDictionary"""

def ProfileDictionary_addTrajOptSolverProfile(dict: tesseract.tesseract_command_language._tesseract_command_language.ProfileDictionary, ns: str, profile_name: str, profile: TrajOptSolverProfile) -> None:
...
class TrajOptMotionPlanner:
    ...
    def solve(self, request: tesseract.tesseract_motion_planners._tesseract_motion_planners.PlannerRequest) -> tesseract.tesseract_motion_planners._tesseract_motion_planners.PlannerResponse: ...

    def terminate(self) -> bool: ...

    def clear(self) -> None: ...

    def clone(self) -> tesseract.tesseract_motion_planners._tesseract_motion_planners.MotionPlanner: ...
