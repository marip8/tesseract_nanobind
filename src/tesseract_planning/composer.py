...
Example:
    from tesseract_planning import Robot, MotionProgram, TaskComposer
...
if TYPE_CHECKING:
    from tesseract_planning.core import Robot
    from tesseract_planning.program import MotionProgram
...
class TaskComposer:
    ...
    def from_config(
        ...
        Example:
            ...
            # Use custom executor
            from tesseract.task_composer import TaskflowTaskComposerExecutor
        ...
        if config_path is None:
            ...
            from tesseract import get_task_composer_config_path
