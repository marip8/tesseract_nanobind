...
```python
from tesseract.trajopt_ifopt import JointJerkConstraint
...
```python
from tesseract.trajopt_ifopt import CartLineInfo, CartLineConstraint
...
```python
from tesseract.trajopt_ifopt import InverseKinematicsInfo, InverseKinematicsConstraint
...
```python
from tesseract.trajopt_ifopt import toBounds
import numpy as np
...
::: tesseract.trajopt_ifopt._trajopt_ifopt
    options:
